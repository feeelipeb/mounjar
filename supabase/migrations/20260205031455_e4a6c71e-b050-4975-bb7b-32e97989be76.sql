...
-- Drop existing DELETE policies and create admin-only DELETE policies
DROP POLICY IF EXISTS "Authenticated users can delete page views" ON public.page_views;
DROP POLICY IF EXISTS "Authenticated users can delete button clicks" ON public.button_clicks;
...
CREATE POLICY "Only admins can delete button clicks"
